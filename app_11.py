...
if df is not None:
    ...
    ax1.set_title(f"Phân tích trạng thái {TICKER}", fontsize=14)
    ax1.legend()
    ...
    ax3.set_title("Phân phối xác suất dự báo")
    ax3.legend()
